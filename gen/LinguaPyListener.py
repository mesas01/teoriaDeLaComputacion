...
class LinguaPyListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LinguaPyParser#bloqueSi.
    def enterBloqueSi(self, ctx:LinguaPyParser.BloqueSiContext):
        pass

    # Exit a parse tree produced by LinguaPyParser#bloqueSi.
    def exitBloqueSi(self, ctx:LinguaPyParser.BloqueSiContext):
        pass


    # Enter a parse tree produced by LinguaPyParser#bloqueSino.
    def enterBloqueSino(self, ctx:LinguaPyParser.BloqueSinoContext):
        pass

    # Exit a parse tree produced by LinguaPyParser#bloqueSino.
    def exitBloqueSino(self, ctx:LinguaPyParser.BloqueSinoContext):
        pass
